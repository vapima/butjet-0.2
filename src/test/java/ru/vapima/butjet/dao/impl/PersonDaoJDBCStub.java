...
public class PersonDaoJDBCStub implements PersonDAO {
Person person=new Person(1,"test","test","test");
    ...
    @Override
    public ArrayList<Person> takeAll(String name) throws SQLException, PersonExeption, AccExeption, PlanExeption {
        ArrayList<Person> people=new ArrayList<>();
        people.add(person);
        return people;
    }
